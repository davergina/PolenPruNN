...
public class Haralick extends AbstractFeatureDescriptor {
     ...
     */
    public double[] getHaralickFeatures(){
    	return features;
    }
    ...
    public String getDescription() {
        ...
        sb.append("Contrast, ");//2
        sb.append("Correlation, ");
        sb.append("variance, ");
        sb.append("Inverse Difference Moment, ");//5
        sb.append("Sum Average, ");//6
        sb.append("Sum Variance, "); //7
        sb.append("Sum Entropy, ");
        sb.append("Entropy, ");
        sb.append("Difference Variance, ");//10
        sb.append("Difference Entropy, ");//11
        sb.append("Information Measures of Correlation, ");//12
    ...
    private void process(ByteProcessor image) {
        ...
        /*for(int i = 0; i < NUM_GRAY_VALUES; i++){
        	for(int j = 0; j < NUM_GRAY_VALUES; j++){
        		Print.print2(cooccurrenceMatrix[i][j]+" ");
        	}
        	Print.print(" ");
        }*/
...
//        Print.print("image.getPixelCount(): "+image.getPixelCount());
        int gray;
//        Print.print("GRAY_SCALE: "+GRAY_SCALE);
        for (int pos = 0; pos < size; pos++) {
            gray = image.get(pos);
//            Print.print("gray: "+gray);
            grayValue[pos] = (byte) (gray / GRAY_SCALE);  // quantized for texture analysis
//            Print.print("grayValue[pos]: "+grayValue[pos]);
            grayHistogram[gray]++;
        }
